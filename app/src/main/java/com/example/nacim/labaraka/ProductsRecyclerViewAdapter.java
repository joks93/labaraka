...
public class ProductsRecyclerViewAdapter extends RecyclerView.Adapter<ProductsRecyclerViewAdapter.ProductViewHolder>{
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        productView.findViewById(R.id.product_grid_cell_textview).setMinimumHeight(parent.getMeasuredHeight() / 2);
        return new ProductViewHolder(productView);
    }

    @Override
    public void onBindViewHolder(final ProductViewHolder holder, final int position) {
        holder.productTextView.setImageDrawable(context.getDrawable(R.drawable.jupe));
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView productTextView;
        ...
        public ProductViewHolder(View itemView) {
            super(itemView);
            productTextView = (ImageView) itemView.findViewById(R.id.product_grid_cell_textview);
